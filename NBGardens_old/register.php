...
<body>
  ...
  <div class="progress-bar progress-bar-success" role="progressbar" value="33" id="progressBar" aria-valuemin="0" aria-valuemax="100" style="width:33%">
    Step 1 of 3
                ...
                <form id="userdetails-form" class="form-inline" onsubmit="return false">
                    <div id="phase1">
                    ...
                    <input type="text" id="email" name="email" placeholder="Email Address" class="form-control field"><br>
                    <input type="password" id="password" name="password" placeholder="Enter a password" class="form-control field">
                    <input type="password" id="conf-password" name="conf-password" placeholder="Confirm your password" class="form-control field"><br>
