...
public class Customer {
	...
	//Constructors
	public Customer() {};
	public Customer(String name, String surname, String email, String phoneNo, String password, Integer permissions, String add1, String add2, String town, String county, String postcode) {
		this.firstName = name;
